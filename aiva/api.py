...
def predict():
    ...
    if request_data['spec']:
        job_Data_Analyst, job_Data_Engineer, job_Data_Scientist, job_Machine_Learning_Engineer = request_data['spec'][0], request_data['spec'][1], request_data['spec'][2], request_data['spec'][3]
    if request_data['lvl']:
        Experience_level_EN, Experience_level_EX, Experience_level_MI, Experience_level_SE = request_data['lvl'][0], request_data['lvl'][1], request_data['lvl'][2], request_data['lvl'][3]
    if request_data['country']:
        Employee_residence_Canada, Employee_residence_India, Employee_residence_UK, Employee_residence_USA = request_data['country'][0], request_data['country'][1], request_data['country'][2], request_data['country'][3]
    if request_data['remote']:
        Remote_ratio_0, Remote_ratio_50, Remote_ratio_100 = request_data['remote'][0], request_data['remote'][1], request_data['remote'][2]
    ...
    if request_data['size']:
        Company_size_L, Company_size_M, Company_size_S = request_data['size'][0], request_data['size'][1], request_data['size'][2]
